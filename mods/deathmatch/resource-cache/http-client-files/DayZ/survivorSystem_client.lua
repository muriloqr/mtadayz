...
--[[
-- Pistol -> M911
weaponTXD = engineLoadTXD ("items/m1911.txd");
engineImportTXD (weaponTXD, 346);
weaponDFF = engineLoadDFF ("items/m1911.dff", 346);
engineReplaceModel (weaponDFF, 346);

-- Country Rifle -> Lee Enfield
weaponTXD = engineLoadTXD ("items/enfield.txd");
engineImportTXD (weaponTXD, 357);
weaponDFF = engineLoadDFF ("items/enfield.dff", 357);
engineReplaceModel (weaponDFF, 357);

-- Shotgun -> Winchester 1866 (M1014)
weaponTXD = engineLoadTXD ("items/winchester.txd");
engineImportTXD (weaponTXD, 349);
weaponDFF = engineLoadDFF ("items/winchester.dff", 349);
engineReplaceModel (weaponDFF, 349);

-- Sniper Rifle -> CZ 550 (M110)
weaponTXD = engineLoadTXD ("items/cz550.txd");
engineImportTXD (weaponTXD, 358);
weaponDFF = engineLoadDFF ("items/cz550.dff", 358);
engineReplaceModel (weaponDFF, 358);
]]
...
--statsWindows = guiCreateWindow(0.775,0.2,0.225,0.22,"DEBUG MONITOR",true)
